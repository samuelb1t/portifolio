...
function Options({isVisible,toggleVisibility}:{isVisible : boolean, toggleVisibility : ()=> void}) {
  ...
  return ( 
    ...
    >
      ...
      >
        <IoClose className="fill-neutral-200 cursor-pointer 2xl:w-16 2xl:h-16" onClick={toggleVisibility}/>
      </motion.div>
        ...
        <div className="grid justify-center justify-items-center text-neutral-200">
          ...
          <div className="flex gap-8">
            <div className="flex items-center">
              ...
              >
                <MdDarkMode className="cursor-pointer 2xl:w-16 2xl:h-16" onClick={()=>{setLight(false)}} />
              </motion.div>
            </div>
            <div className="flex mr-3 items-center">
              ...
              >
                <MdLightMode className="cursor-pointer 2xl:w-16 2xl:h-16" onClick={()=>{setLight(true)}}/>
              </motion.div>
            </div>
          </div>
        </div>

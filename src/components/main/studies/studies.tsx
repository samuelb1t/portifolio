...
function Studies() {
  return (
    <section className="grid studies-columns gap-14">
      <h1 className="text-neutral-800 text-8xl leading-none">
        ES
        <br />
        TU
        <br />
      ...
      <section className="text-neutral-200 grid">
        <h2 className="block text-5xl mb-2">
          Faculdade<span className="text-red-700 text-7xl leading-10">.</span>
        </h2>
        <div className="grid grid-cols-2 gap-8 text-font">
          <div className="border-2 rounded-xl p-2 box-border grid">
            <h3 className="text-xl">Engenharia de Computação</h3>
            <span className="text-lg block">UERGS</span>
            <span className="text-lg">2023/2 - 2024/1</span>
          </div>
          <div className="border-2 rounded-xl p-2 box-border grid">
            <h3 className="text-xl">Engenharia de Software</h3>
            <span className="text-lg block">PUC-RS</span>
            <span className="text-lg">2024/2 - hoje</span>
          </div>
        </div>
        <h2 className="block text-5xl mb-2 mt-4">
          Demais cursos
          <span className="text-red-700 text-7xl leading-10">.</span>
        </h2>
        <div className="bg-neutral-800 p-2 flex overflow-auto gap-5 rounded-xl" id="course-container">
            <InfiniteMovingCards
            items={courses}
            direction="right"
            speed="normal"
